  ...
  <div class="space-y-6">
    ...
    <form onsubmit={e => { e.preventDefault(); handleSave() }} class="space-y-6 max-w-lg">
      <div>
        ...
        />
        <p class="text-xs text-gray-400 mt-1">Shown on printed reports</p>
      </div>

      <div class="grid grid-cols-2 gap-4">
        <div>
          <label for="default-arm" class="block text-sm font-medium text-gray-700 mb-1">Default Arm</label>
          <select
            id="default-arm"
        ...
        <div>
          <label for="default-position" class="block text-sm font-medium text-gray-700 mb-1">Default Position</label>
          <select
            id="default-position"
      ...
      <div class="flex items-center gap-3">
        ...
        {#if saved}
          <span class="text-sm text-teal-600 font-medium">Settings saved</span>
        {/if}
      </div>
    </form>
  </div>
